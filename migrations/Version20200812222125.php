...
final class Version20200812222125 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE restaurant (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id INT DEFAULT NULL, name VARCHAR(512) NOT NULL COMMENT \'Название ресторана\', slug VARCHAR(512) NOT NULL COMMENT \'Слаг для ресторана\', description VARCHAR(2048) DEFAULT NULL COMMENT \'Описание ресторана\', address VARCHAR(512) NOT NULL COMMENT \'Месторасположение ресторана\', phone VARCHAR(14) DEFAULT NULL, legal_name VARCHAR(512) DEFAULT NULL COMMENT \'Юридическое наименование организации\', inn VARCHAR(14) DEFAULT NULL, INDEX IDX_3A3C5C82A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'Сведения о точке общественного питания\' ');
        $this->addSql('CREATE TABLE restaurant_file (restaurant_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', file_id INT NOT NULL, INDEX IDX_939FD76EBD91643B (restaurant_id), INDEX IDX_939FD76E93CB796C (file_id), PRIMARY KEY(restaurant_id, file_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE restaurant ADD CONSTRAINT FK_3A3C5C82A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE restaurant_file ADD CONSTRAINT FK_939FD76EBD91643B FOREIGN KEY (restaurant_id) REFERENCES restaurant (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE restaurant_file DROP FOREIGN KEY FK_939FD76EBD91643B');
